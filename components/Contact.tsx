        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <a 
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 bg-green-600 hover:bg-green-500 text-white rounded-lg font-bold transition-all"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 px-8 py-4 bg-white hover:bg-slate-100 text-slate-900 rounded-lg font-bold transition-all"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 px-8 py-4 bg-[#24292F] hover:bg-[#24292F]/90 text-white border border-slate-700/50 rounded-lg font-bold transition-all"
            >
